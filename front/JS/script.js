...
async function displayProducts() {
  ...
  canaps.forEach((canap) => {
    console.log(canap);
    list += `<a href="./product.html?id=${canap._id}"><article><img src="${canap.imageUrl}" alt="Lorem ipsum dolor sit amet, Kanap name1" /><h3 class="productName">${canap.name}</h3></article></a>`;
  });
